...
def load_matchups():
    matchups = pd.read_parquet('DATA_PERMANENT/2024/MATCHUPS/matchups.parquet', engine='pyarrow')
...
def load_rosters():
    rosters = pd.read_parquet('DATA_PERMANENT/2024/ROSTERS/rosters.parquet', engine='pyarrow')
